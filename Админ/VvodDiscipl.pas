...
begin
 if Length(Trim(LabeledEdit1.Text)) = 0 then
   begin
     MessageDlg('Вы не указали НазвДисципл!',mtError,[mbOk],0); // Диалоговое окно.
     Exit     //Выход
  end;
...
MessageDlg('Новая Дисциплина успешно добавлена.',mtInformation,[mbOK],0);  // Диалоговое окно.

FDMSN.ADOQueryDisciplina.Close;
FDMSN.ADOQueryDisciplina.Open;
DBGrid1.Columns.Items[0].Title.Caption :='КодДисципл';
 DBGrid1.Columns.Items[1].Title.Caption :='НазвДисципл';
end;
