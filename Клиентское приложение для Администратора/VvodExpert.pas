...
FVvodExpert.DBGrid2.Columns.Items[0].Title.Caption :='Код Студента';
FVvodExpert.DBGrid2.Columns.Items[1].Title.Caption :='ФИО';

FVvodExpert.DBGrid2.Columns.Items[3].Title.Caption :='Пароль';
FVvodExpert.DBGrid2.Columns.Items[4].Title.Caption :='Код Группы';
end;
