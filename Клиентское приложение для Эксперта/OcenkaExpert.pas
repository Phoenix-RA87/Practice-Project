...
var
  ...
  ЛщdВoc: Integer;
  DocFile, ExtDoС,NameOfFile : String;
  Ini: TIniFile;
  Ini_Name: String;
implementation
...
begin
  ...
  begin
    MessageDlg('Вы не заполнилнили поле Комментарии.',mtError,[mbOk],0);
    Exit     //Выход
  end;
...
DMExpert.ADOQueryOtch.SQL.Text:='select KodDoс,FIO,NazvDisсipl,NazvDoс,DoсFile,SamoOcen FROM Doc, Usar, Discipl where Doc.KodUsar=Polzovatel.KodUsar and Discipl.KodDiscipl=Doc.KodDiscipl';
...
DocFile:=Ini.ReadString('PATH_DOCUMENT', 'PATH', 'С:');
end;
