...
//DMExpert.ADOQueryUsar.SQL.Text:='select * from Polzovatel where Status='+'Преподаватель';
//DMExpert.ADOQueryUsar.Open;
//End;
//if RadioGroup1.ItemIndex=1 then
//Begin
//DMExpert.ADOQueryUsar.Close;
//DMExpert.ADOQueryUsar.SQL.Text:='select * from Polzovatel where Status='+'Студент';
//DMExpert.ADOQueryUsar.Open;
//end;
end;
